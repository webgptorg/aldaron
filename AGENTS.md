...
- `/cs/komunita/clenstvi` - The Czech landing page for the community membership. It presents Free, Premium and Premium+ from one shared plan catalogue, focuses on Premium, and lets a visitor send an application with a server-calculated monthly or annual quote. Premium costs 150 CZK per month and Premium+ 1000 CZK per month; both have a seven-day trial, the annual payment takes 20% off, and a valid shared discount code is applied after that annual reduction. There is no payment-provider integration in this app, so an application reserves the verified quote in the contacts administration and the activation link is sent separately.
