                    ...
                    {comparisons.map((row, i) => (
                        ...
                        >
                                ...
                                <div className="rounded-xl border border-[#010080]/20 bg-white overflow-hidden">
                                    <div className="grid grid-cols-[1fr_1px_1fr]">
                                        ...
                                        <div className="py-5 px-5 flex items-center justify-center gap-3">
                                            <p className="text-[14.5px] text-gray-500 leading-relaxed text-center">{row.chatgpt}</p>
                                        ...
                                        <div className="py-5 px-5 flex items-center justify-center gap-3">
                                            ...
                                            <p className="text-[14.5px] font-medium text-[#0f172a] leading-relaxed text-center">{row.promptbook}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="md:hidden space-y-3">
                                ...
                                <p className={`text-[14px] font-bold text-[#0f172a] text-center uppercase tracking-wide ${i > 0 ? 'mt-5' : ''}`}>
                                    {row.feature}
                                </p>
                                ...
                                <div className="flex justify-start">
                                    <div className="bg-red-50/80 rounded-2xl rounded-tl-md border border-red-200/50 px-5 py-3 max-w-[85%]">
                                        <span className="text-[10px] font-semibold text-red-400 uppercase tracking-wider">ChatGPT</span>
                                        <p className="text-[14.5px] text-gray-600 leading-relaxed mt-1">{row.chatgpt}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-end">
                                    <div className="bg-cyan-50/80 rounded-2xl rounded-tr-md border border-cyan-200/50 px-5 py-3 max-w-[85%]">
                                        <span className="text-[10px] font-semibold text-cyan-500 uppercase tracking-wider">Promptbook</span>
                                        <p className="text-[14.5px] font-medium text-[#0f172a] leading-relaxed mt-1">{row.promptbook}</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
