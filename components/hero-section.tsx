            ...
            >
              <div className="space-y-4">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Reclaim Your <span className="bg-gradient-purple bg-clip-text text-transparent">Time</span> with AI That Thinks Like <span className="bg-gradient-blue bg-clip-text text-transparent">You</span>
                </h1>
