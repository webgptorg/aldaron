...
import { ArrowRight, ArrowLeft, CheckCircle2, Send, X } from 'lucide-react';
...
const questions: Question[] = [
    ...
    },
    {
        ...
        type: 'single',
        options: ['Výroba / Průmysl', 'Právo / Advokacie', 'Stavebnictví', 'Veřejná správa', 'Zdravotnictví', 'IT / Technologie', 'Finance / Bankovnictví', 'Vzdělávání', 'Jiné'],
    },
    {
        id: 'pain_point',
...
export function QualificationPopup() {
    ...
    // Listen for open-waitlist event
    useEffect(() => {
                ...
                {isSubmitted ? (
                    ...
                    <div className="px-8 py-14 text-center">
                        ...
                        <p className="text-[15px] text-gray-500 leading-relaxed mb-2">
                            Na <strong className="text-[#0f172a]">{answers.email}</strong> vám do 24 hodin pošleme odkaz na rezervaci strategického hovoru.
                        </p>
