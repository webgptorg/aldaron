...
import { ArrowRight, Bot, MessageSquareText, Upload } from 'lucide-react';
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            ...
                            <div className="relative mx-auto mb-8">
                                <div
                                    className={`w-[90px] h-[90px] rounded-full bg-gradient-to-br ${step.gradient} p-[2px] mx-auto`}
                                >
                                ...
                                <div
                                    className={`absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-br ${step.gradient} flex items-center justify-center`}
                                >
                            ...
                            {/* Content */}
                            <h3 className="text-lg font-bold text-[#0f172a] tracking-tight mb-3">{step.title}</h3>
