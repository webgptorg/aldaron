...
[✨👮] Fix "The URL shortener should be under the admin."

-   @@@
-   You have implemented the "The URL shortener should be under the admin." feature, but it is not working, fix it
