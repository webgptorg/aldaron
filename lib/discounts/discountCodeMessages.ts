...
/**
 * What a visitor reads under the discount-code field of any place. A limited code says how many
 * uses are left of it, which is the only reason the remaining count is carried to the browser.
 */
