...
export const WORKSHOP_PROJECT_TABLE_NAME = 'workshop_projects';
...
export const MAXIMAL_WORKSHOP_PROJECT_TITLE_LENGTH = 200;
export const MAXIMAL_WORKSHOP_PROJECT_DESCRIPTION_LENGTH = 2_000;
export const MAXIMAL_WORKSHOP_PROJECT_URL_LENGTH = 2_000;
export const MAXIMAL_VISIBLE_WORKSHOP_PROJECT_COUNT = 100;
export const MAXIMAL_VISIBLE_OWN_WORKSHOP_PROJECT_COUNT = 50;
export const MAXIMAL_ADMIN_WORKSHOP_PROJECT_LIST_COUNT = 1_000;
