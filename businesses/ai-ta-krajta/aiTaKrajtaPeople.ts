...
export const AI_TA_KRAJTA_PEOPLE: readonly AiTaKrajtaPerson[] = [
    {
        ...
        name: 'Pavol Hejný',
        role: 'host',
        headline: 'AI konzultant a vývojář. Staví Promptbook a agenty, které pak v dílech rozebírá z praxe.',
    ...
    },
    {
        ...
        name: 'Jiří Jahn',
        role: 'host',
        headline: 'CEO Promptbooku. Tahá debatu k otázce, co z toho firma reálně použije.',
