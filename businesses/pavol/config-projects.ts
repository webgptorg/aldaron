...
import { Bot, GraduationCap, Presentation, Rocket } from 'lucide-react';
    ...
    cs: [
        {
            ...
            links: [{ href: '/', label: 'Otevřít Promptbook' }],
        },
        {
            icon: GraduationCap,
            ...
            links: [
                { href: 'https://collboard.com/', label: 'Collboard' },
                { href: 'https://www.h-edu.cz/', label: 'H-edu' },
            ],
        },
        {
            icon: Presentation,
            ...
            links: [{ href: '/ai-supervize', label: 'AI Supervize' }],
        },
        {
            icon: Rocket,
            ...
            links: [
                { href: 'https://github.com/hejny', label: 'GitHub' },
                {
    ...
    en: [
        {
            ...
            links: [{ href: '/', label: 'Open Promptbook' }],
        },
        {
            icon: GraduationCap,
            title: 'Collboard & H-edu',
