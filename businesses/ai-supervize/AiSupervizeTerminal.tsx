...
export function AiSupervizeTerminal({
    ...
    initializingText = 'Načítám konfiguraci AI Supervize...',
    okLines = ['Konfigurace načtena', 'Metriky sprintu načteny', 'Porovnání s výchozím stavem hotové'],
    reportTitle = 'PŘEHLED METRIK',
    reportSubtitle = 'sprint 12 vs. výchozí stav',
    doneText = 'Analýza hotová. Můžeme nastavit AI Supervizi.',
